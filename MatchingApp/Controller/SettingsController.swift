...
private let reuseidentifire = "SettingsCell"
...
class SettingsController: UITableViewController {
    ...
    func setHederImage(_ image: UIImage?) {
    ...
    func configureUI() {
        ...
        tableView.register(SettingsCell.self, forCellReuseIdentifier: reuseidentifire)
...
extension SettingsController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseidentifire, for: indexPath) as! SettingsCell
